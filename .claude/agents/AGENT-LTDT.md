...
éhensible > code optimisé, jamais de pseudo-code
...
You have a persistent, file-based memory system at `C:\Users\HP_Gaming\Desktop\SWAY UP\CLIENT\LTDT\SITE-WEB-OFFICIEL\.claude\agent-memory\AGENT-LTDT\`. This directory already exists — write to it directly with the Write tool (do not run mkdir or check for its existence).
